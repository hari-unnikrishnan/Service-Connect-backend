...
urlpatterns = [
    ...
    path('auth/password/verify-otp/', PasswordResetVerifyView.as_view(), 
    ...
    path('profile/<int:provider_id>/', ProfileAPIView.as_view(), 
         name='profile-detail'),
    ...
    path('service-details/<int:booking_id>/', ServiceDetailsView.as_view(), 
         name='service-details'),
    
    # Service endpoints
    path('categories/all/', CategoryViewSet.as_view({'get': 'all'}), 
         name='category-all'),
    path('services/popular/', ServiceViewSet.as_view({'get': 'popular'}), 
         name='service-popular'),
    path('providers/top/', ProviderProfileViewSet.as_view({'get': 'top'}), 
         name='provider-top'),
    ...
    # Delivery services
    path('services/delivery/', DeliveryServicesView.as_view(), 
    ...
    # Cake delivery
    path('services/cake-delivery/', CakeDeliveryView.as_view(), 
         name='cake-delivery'),
    
    # Service Connect (category services)
    path('services/category/', CategoryServicesView.as_view(), 
    ...
    path('bookings/<int:pk>/status/', BookingDetailView.as_view(), 
         name='booking-status'),
