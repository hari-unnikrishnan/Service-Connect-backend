...
export default function Jobs({onNavigateBack,onNavigateToProfiless}) {
  ...
  return (
    <div className="jobs-page">
      <div className="jobs-container">
        ...
        {/* TABS */}
        <div className="tabs" onClick={onNavigateToProfiless}>
          ...
          <div className="job-card" key={i}>
            ...
            <div className="job-content">
              ...
              <div className="user">
                ...
                <span className="Kes">Keshavan</span>
              </div>
              ...
              {/* BUTTON */}
                <button className="pay-btn" onClick={onNavigateToProfiless}>
                    Complete Payment
