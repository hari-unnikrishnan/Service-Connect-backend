...
export default function CakeDelivery({ onNavigateToDeliveryServices ,onNavigateToSearch,onNavigateToFilter}) {
  const providers = [
    {
      name: "Thomas",
      distance: "3 km away",
      ...
      <div className="cake-phone">
        ...
        <header className="cake-header">
          <div className="cake-left">
             <button
                className="back-btn"
                onClick={() => onNavigateToDeliveryServices("CAKE DELIVERY")}
                >
                &#8249;
            </button>
            <h1>CAKE DELIVERY</h1>
          ...
          <div className="cake-right">
           <SlidersHorizontal size={16}  onClick={onNavigateToFilter}
